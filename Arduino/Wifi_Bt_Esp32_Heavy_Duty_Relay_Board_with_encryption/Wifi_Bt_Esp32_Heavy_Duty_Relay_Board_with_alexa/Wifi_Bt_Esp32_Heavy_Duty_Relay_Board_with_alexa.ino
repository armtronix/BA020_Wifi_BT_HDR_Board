...
/*
 * Date Edited : 13-03-19 alfa 001
 Edited By:Naren 

 Previous Edited Date : 02-11-18
 Previously Edited By: Karthik
...
int wifi_input_status_12; //wifi command state of the switch for relay 2
 ...
 // Mqtt switch status publish flag 
int send_status_12;
...
/*##########  Virtual Switch Status Update  ######################################################*/
  if(switch_status_12==(switch_phase_detect()))// to read the status of physical switch
     {
        // send_status=0;
     }
  else
     {
      switch_status_12=(switch_phase_detect());
